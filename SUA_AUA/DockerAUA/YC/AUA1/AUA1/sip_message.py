...
class SIPMessageApplication(SIPApplication):
	...
	>>> Using account aiottalk@xxx.xxx.xxx.xxx
	...
	def _NH_SIPApplicationWillStart(self, notification):
		...
		#print self.account >>>> Account('device@xxx.xxx.xxx.xxx')
	...
	def _NH_SIPEngineGotMessage(self, notification):
		...
		try:
			...
			filename = _date+"(AUA)"+"_"+sub_device[0]+".txt"
	...
	def _send_message(self):
		...
		if self.routes:
			...
			# Sending MESSAGE from 'sip:aiottalk@xxx.xxx.xxx.xxx' to 'sip:device5@xxx.xxx.xxx.xxx' using proxy sip:xxx.xxx.xxx.xxx:5566
